...
[Agent-Native app configuration guide](../packages/core/docs/content/agent-native-config.mdx)
instead of adding another `VITE_*` flag. Keep credentials and deployment-
specific values in the environment or scoped secret store.
