...
import { registerNetlifyBackgroundTransport } from "./background-transport.js";

export function registerNetlifyHost(): void {
  registerNetlifyBackgroundTransport();
}
