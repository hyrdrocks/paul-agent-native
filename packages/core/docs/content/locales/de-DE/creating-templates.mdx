...
<Diagram id="doc-block-1pikucf" title="Wie die vier Bereiche einer Vorlage miteinander verbunden sind" summary={"Die Benutzeroberfläche und der Agent erreichen SQL beide über dieselben Aktionen; Anwendungsstatus und Abfragesynchronisierung sorgen dafür, dass sie aufeinander abgestimmt sind."}>
...
<div class="diagram-tmpl">
  ...
  <div class="diagram-box" data-rough>
    SQL über Drizzle<br /><small class="diagram-muted">additive schema</small>
  </div>
