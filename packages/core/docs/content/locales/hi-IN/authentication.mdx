...
वह शेल कितनी देर कैश रहता है यह पूरे परिनियोजन की सेटिंग है — `AGENT_NATIVE_SSR_CACHE` के लिए [SSR Caching](/docs/deployment#ssr-caching) देखें। कैश को छोटा या अक्षम करने से केवल अवधि बदलती है; SSR अब भी कुकीज़ हटाकर अनाम ब्रांच रेंडर करता है।
