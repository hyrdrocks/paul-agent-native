...
<Diagram id="doc-block-pp7sdt" title={"Como as quatro áreas de um modelo se conectam"} summary={"A UI e o agente alcançam SQL através das mesmas ações; o estado do aplicativo e a sincronização de pesquisa os mantêm alinhados."}>
...
<div class="diagram-tmpl">
  ...
  <div class="diagram-box" data-rough>
    SQL com Drizzle<br /><small class="diagram-muted">additive schema</small>
  </div>
