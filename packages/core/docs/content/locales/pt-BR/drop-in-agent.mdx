...
Você não precisa criar um agente nativo do zero. O bate-papo do agente, a guia Recursos do Agente, o terminal CLI, a entrada de voz e toda a infraestrutura relacionada são fornecidos como um punhado de componentes React que você coloca em qualquer aplicativo.
