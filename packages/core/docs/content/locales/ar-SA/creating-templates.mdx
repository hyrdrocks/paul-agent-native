...
<Diagram id="doc-block-7npsk8" title={"كيف تتصل المناطق الأربع للقالب"} summary={"يصل كل من واجهة المستخدم والوكيل إلى SQL من خلال نفس الإجراءات؛ حالة التطبيق ومزامنة الاستقصاء تحافظ على توافقهما."}>
...
<div class="diagram-tmpl">
  ...
  <div class="diagram-box" data-rough>
    SQL عبر Drizzle<br /><small class="diagram-muted">additive schema</small>
  </div>
