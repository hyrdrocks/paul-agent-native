...
- **`type`** — يحتفظ `"content"` (افتراضي) بالعمل في وكيل التطبيق المضمن الذي يعمل من خلال أدوات التطبيق. يوجه `"code"` إلى إطار منفصل قادر على التعامل مع الكود لإجراء تغييرات مصدر المستودع؛ ولا تتوفر الكتابة إلا عندما يمنح المضيف عمدًا أدوات repository/workspace. راجع [Frames](/docs/frames).
