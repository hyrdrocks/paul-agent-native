...
<Diagram id="doc-block-1gl364t" title={"Comment les quatre zones d'un modèle se connectent"} summary={"L'interface utilisateur et l'agent atteignent tous deux SQL via les mêmes actions ; l'état de l'application et la synchronisation des interrogations les maintiennent alignés."}>
...
<div class="diagram-tmpl">
  ...
  <div class="diagram-box" data-rough>
    SQL avec Drizzle<br /><small class="diagram-muted">additive schema</small>
  </div>
