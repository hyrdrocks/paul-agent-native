...
<Diagram id="doc-block-hjg2nf" title={"템플릿의 네 가지 영역이 연결되는 방식"} summary={"UI와 에이전트는 모두 동일한 작업을 통해 SQL에 도달합니다. 애플리케이션 상태와 폴링 동기화가 정렬된 상태를 유지합니다."}>
...
<div class="diagram-tmpl">
  ...
  <div class="diagram-box" data-rough>
    Drizzle 기반 SQL<br /><small class="diagram-muted">additive schema</small>
  </div>
