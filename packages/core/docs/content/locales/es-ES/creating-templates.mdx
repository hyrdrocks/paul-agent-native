...
<Diagram id="doc-block-1reooa2" title={"Cómo se conectan las cuatro áreas de una plantilla"} summary={"Tanto la UI como el agente llegan a SQL mediante las mismas acciones; el estado de la aplicación y la sincronización del sondeo los mantienen alineados."}>
...
<div class="diagram-tmpl">
  ...
  <div class="diagram-box" data-rough>
    SQL vía Drizzle<br /><small class="diagram-muted">additive schema</small>
  </div>
